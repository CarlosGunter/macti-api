...
def run_migrations_online():
    ...
    # Ensure Alembic knows the SQLAlchemy URL
    config.set_main_option("sqlalchemy.url", SQLALCHEMY_DATABASE_URL)
    # get_section may return None; ensure we pass a dict to engine_from_config
    ...
    with connectable.connect() as connection:
        # enable compare_type so Alembic detects column type changes
        context.configure(
